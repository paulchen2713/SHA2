%
% SHA2_64 main program
%     4 HASH types: SHA-384, SHA-512, SHA-512/224, SHA-512/256
%     input string: no limits.
%
clear;
clc;
%
...
H_512 = ['6a09e667f3bcc908';
         ...
         '5be0cd19137e2179'];
%
% Input the hash type and the data to be hashed
%
HASH_type = 'SHA-512/256';
input_str = '53048e2681941ef99b2e29b76b4c7dabe4c2d0c634fc6d46e0e2f13107e7af23';
%
% indices
%   128 == 1024 / 8
%   16  == 128 / 8
...
%
%
if strcmp(HASH_type, 'SHA-384') == 1
    H = H_384;
    HASH_len = 384;
elseif strcmp(HASH_type, 'SHA-512') == 1
    H = H_512;
    HASH_len = 512;
elseif strcmp(HASH_type, 'SHA-512/224') == 1
    H = IV_generation('SHA-512/224');
    HASH_len = 224;
elseif strcmp(HASH_type, 'SHA-512/256') == 1
    H = IV_generation('SHA-512/256');
    HASH_len = 256;
end
%
% parse the message
