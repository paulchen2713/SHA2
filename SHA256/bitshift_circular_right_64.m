...
%
function out=bitshift_circular_right_64(a_hex,num)
a=a_hex;
shift_num=num;
a_left=a(1:8);
a_right=a(9:16);
...
if shift_num < 32
    ...
    temp_right=bitget(a_right_dec,1:shift_num);
    a_left_dec=bitshift(a_left_dec,-shift_num);
    a_right_dec=bitshift(a_right_dec,-shift_num);
    for i=1:shift_num
        a_left_dec=bitset(a_left_dec,32-shift_num+i,temp_right(i));
...
elseif shift_num == 32
    ...
    out=bitshift_circular_left_64(a,64-shift_num);
end
return
